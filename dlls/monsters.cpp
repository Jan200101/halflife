...
int CBaseMonster::IRelationship ( CBaseEntity *pTarget )
{
	...
	{			 //   NONE	 MACH	 PLYR	 HPASS	 HMIL	 AMIL	 APASS	 AMONST	APREY	 APRED	 INSECT	PLRALY	PBWPN	ABWPN   APET
	...
	/*PLAYER*/		{ R_NO	,R_DL	,R_NO	,R_NO	,R_DL	,R_DL	,R_DL	,R_DL	,R_DL	,R_DL	,R_NO	,R_NO,	R_DL,	R_DL,	R_AL },
	...
	/*PLAYERALLY*/	{ R_NO	,R_DL	,R_AL	,R_AL	,R_DL	,R_DL	,R_DL	,R_DL	,R_DL	,R_DL	,R_NO	,R_NO,	R_NO,	R_NO,	R_AL },
	...
	/*ALIENTPET*/	{ R_NO	,R_DL	,R_AL	,R_AL	,R_HT	,R_HT	,R_NO	,R_DL	,R_DL	,R_DL	,R_FR	,R_AL,	R_NO,	R_NO,	R_NO }
	};
